...
async def upload_document(
    ...
    schedule_ingest(str(document.id), background_tasks)
...
async def list_documents(
    ...
    items, total = await document_service.list(department=department, page=page, page_size=page_size)
...
async def get_document(
    ...
    document = await document_service.get(UUID(document_id))
    if not document:
...
async def delete_document(
    ...
    try:
        await document_service.delete(UUID(document_id))
    except ValueError as exc:
