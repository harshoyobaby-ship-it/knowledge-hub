...
export const PERMISSIONS = {
  ...
  ASSIGN_FOUNDER_TASKS: [UserRole.SUPER_ADMIN, UserRole.ADMIN],
  ...
  FOLLOW_DEPARTMENT_TASKS: [UserRole.MANAGER, UserRole.DEPARTMENT_HEAD, UserRole.EMPLOYEE, UserRole.STUDENT],
